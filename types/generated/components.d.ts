...
export interface SharedSocial extends Schema.Component {
  ...
  attributes: {
    ...
    social: Attribute.Enumeration<
      ['instagram', 'facebook', 'youtube', 'linkedln', 'tiktok']
    >;
  };
}
...
export interface SharedService extends Schema.Component {
  ...
  attributes: {
    ...
    caseServiceTags: Attribute.Relation<
      'shared.service',
      'oneToMany',
...
export interface HomeSlider extends Schema.Component {
  ...
  attributes: {
    ...
    speedTransition: Attribute.Integer;
  };
}
...
export interface HomeCollaborators extends Schema.Component {
  collectionName: 'components_home_collaborators';
  info: {
